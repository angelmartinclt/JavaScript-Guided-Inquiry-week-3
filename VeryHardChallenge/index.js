...
Person.prototype.exercise = function(){
    console.log("Running is actually very hard, who knew?");
};
...
<h3>Programmers Languages : <h3>
<p>${c1.name} : ${c1.listLanguages()}</p>
<p>${c2.name} : ${c2.listLanguages()}</p>
<p>${c3.name} : ${c3.listLanguages()}</p>
`;